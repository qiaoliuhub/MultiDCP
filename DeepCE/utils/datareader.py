...
class AEDataReader(object):
    ...
    def __init__(self, input_file_name, label_file_name, device):
        ...
        self.train_feature = pd.read_csv(self.input_file_name + '_train.csv').values.to(device)
        self.dev_feature = pd.read_csv(self.input_file_name + '_dev.csv').values.to(device)
        self.test_feature = pd.read_csv(self.input_file_name + '_test.csv').values.to(device)
        self.train_label = pd.read_csv(self.label_file_name + '_train.csv').values.to(device)
        self.dev_label = pd.read_csv(self.label_file_name + '_dev.csv').values.to(device)
        self.test_label = pd.read_csv(self.label_file_name + '_test.csv').values.to(device)
