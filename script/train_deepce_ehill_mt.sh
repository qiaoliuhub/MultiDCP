...
CUDA_VISIBLE_DEVICES=1 python ../DeepCE/ehill_deepce_mt.py --drug_file "../DeepCE/data/all_drugs_l1000.csv" \
--gene_file "../DeepCE/data/gene_vector.csv"  --hill_train_file "../DeepCE/data/ehill_data/high_confident_data_train.csv" \
--hill_dev_file "../DeepCE/data/ehill_data/high_confident_data_dev.csv" \
--hill_test_file "../DeepCE/data/AMPAD_data/top_drug_in_ad.csv" \
