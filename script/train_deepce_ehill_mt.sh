...
--gene_file "../DeepCE/data/gene_vector.csv"  --hill_train_file "../DeepCE/data/ehill_data/signature_train_pretraining_ehill_unit_tri.csv" \
--hill_dev_file "../DeepCE/data/ehill_data/signature_dev_pretraining_ehill_unit_tri.csv" \
--hill_test_file "../DeepCE/data/ehill_data/signature_test_pretraining_ehill_unit_tri.csv" \
...
--cell_ge_file "../DeepCE/data/adjusted_ccle_tcga_ad_tpm_log2" #\
