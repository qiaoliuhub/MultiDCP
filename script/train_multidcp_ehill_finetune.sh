...
CUDA_VISIBLE_DEVICES=7 python ../MultiDCP/ehill_multidcp_finetune.py \
--drug_file "../MultiDCP/data/all_drugs_l1000.csv" \
--gene_file "../MultiDCP/data/gene_vector.csv"  --hill_train_file "../MultiDCP/data/ehill_data/pert_transcriptom/high_confident_data_train.csv" \
