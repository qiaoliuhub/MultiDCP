...
CUDA_VISIBLE_DEVICES=3 python ../MultiDCP/multidcp_ae_pretrain.py --drug_file "../MultiDCP/data/drugs_smiles.csv" \
...
"../MultiDCP/data/gene_expression_for_ae/gene_expression_combat_norm_978_split3" \
--ae_label_file "../MultiDCP/data/gene_expression_for_ae/gene_expression_combat_norm_978_split3"  \
