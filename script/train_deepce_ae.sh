...
CUDA_VISIBLE_DEVICES=2 python ../DeepCE/deepce_ae.py --drug_file "../DeepCE/data/all_drugs_l1000.csv" \
--gene_file "../DeepCE/data/gene_vector.csv"  --train_file "../DeepCE/data/signature_train_cell_4_v1.csv" \
...
--predicted_result_for_testset "../DeepCE/data/low_quality_data/low_quality_perturbedGX_v1.csv" \
--hidden_repr_result_for_testset "../DeepCE/data/low_quality_data/low_quality_hidden_cells_v1.csv" \
