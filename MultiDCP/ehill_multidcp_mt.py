...
data.setup()
print('#Train hill data: %d' % len(hill_data.train_data.data.feature['drug']))
print('#Dev hill data: %d' % len(hill_data.dev_data.data.feature['drug']))
print('#Test hill data: %d' % len(hill_data.test_data.data.feature['drug']))
print('#Train perturbed data: %d' % len(hill_data.train_data.data.feature['drug']))
print('#Dev perturbed data: %d' % len(hill_data.dev_data.data.feature['drug']))
print('#Test perturbed data: %d' % len(hill_data.test_data.data.feature['drug']))

# model creation
model = multidcp.MultiDCPEhillPretraining(drug_input_dim=drug_input_dim, drug_emb_dim=drug_embed_dim,
